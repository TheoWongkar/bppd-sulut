        ...
        <div class="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div x-data="{
                ...
                <div class="w-full lg:w-3/4">
                    <div class="aspect-video bg-gray-200 rounded-xl overflow-hidden shadow-md">
                        <img :src="mainImage" alt="Thumbnail Culinary"
                ...
                <div class="w-full lg:w-1/4">
                    <div class="flex gap-2 overflow-x-auto lg:overflow-visible lg:flex-col">
                        @forelse ($culinaryPlace->images as $image)
                            <img src="{{ asset('storage/' . $image->image) }}" alt="Galeri Culinary"
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-[2fr_1fr] lg:grid-cols-[3fr_1fr] gap-6">
                ...
                <div class="bg-white p-4 rounded-xl shadow-md">
                    ...
                    <div class="flex flex-col md:flex-row gap-6 text-sm">
                        ...
                        <div class="flex-1 space-y-3">
                            <div>
                                ...
                                <!-- Tipe Makanan -->
                                <a href="{{ $culinaryPlace->menu_pdf }}" target="__BLANK"
                                    class="flex items-center gap-2 text-[#486284]">
                                    <x-icons.type />
                            ...
                            <div>
                                ...
                                @foreach (json_decode($culinaryPlace->facility) as $item)
                    ...
                    <!-- Google Maps -->
                    <iframe src="{{ $culinaryPlace->gmaps_link }}" width="100%" height="200" style="border:0;"
        ...
        <div class="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                ...
                <div>
                    ...
                    <form
                        action="{{ $myReview
                            ? route('culinaryplace-review.update', [$culinaryPlace->subCategory->slug, $culinaryPlace->slug])
                            : route('culinaryplace-review.store', [$culinaryPlace->subCategory->slug, $culinaryPlace->slug]) }}"
