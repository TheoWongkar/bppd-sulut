<x-main-layout>
    ...
    <header class="relative">
        ...
        <div class="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
            ...
            <p class="text-white text-sm mt-2 max-w-2xl text-balance">
                Temukan tempat wisata terbaik di Sulawesi
            </p>
        </div>
    </header>
    ...
    <section class="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
                    ...
                    @forelse ($tourPlaces as $tourPlace)
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition">
                            ...
                            <div class="p-4">
                                ...
                                @php
                                    $rating = round($tourPlace->reviews_avg_rating ?? 0);
                                @endphp
                                ...
                                <a href="{{ route('tourplace.show', [$tourPlace->subCategory->slug, $tourPlace->slug]) }}"
        ...
        <!-- Pagination -->
        <div class="mt-10">
            {{ $tourPlaces->appends(request()->query())->links('pagination::main') }}
        </div>
    </section>
